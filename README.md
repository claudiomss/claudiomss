...
Possuo experiência prática em backend como apoio ao frontend, incluindo criação e deploy de servidores em Node.js, integração com APIs e uso de bancos de dados relacionais e não relacionais.

Também tenho vivência com infraestrutura básica, como configuração de VPS em Linux, automações de fluxos e integrações, além do desenvolvimento de bots para Telegram.
